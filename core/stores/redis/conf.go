...
type (
	...
	RedisConf struct {
		Host     string
		Type     string `meta:",default=node,options=node|cluster"`
		User     string `meta:",optional"`
		Pass     string `meta:",optional"`
		Tls      bool   `meta:",optional"`
		NonBlock bool   `meta:",default=true"`
		// PingTimeout is the timeout for ping redis.
		PingTimeout time.Duration `meta:",default=1s"`
	}
